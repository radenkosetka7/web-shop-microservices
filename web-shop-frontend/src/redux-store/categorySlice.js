...
export const updateCategory = createAsyncThunk("categories/updateCategory", async ({id,value}, {rejectWithValue}) => {
    try {
...
export const updateAttrbiute = createAsyncThunk("categories/updateAttribute", async ({id,value}, {rejectWithValue}) => {
    try {
