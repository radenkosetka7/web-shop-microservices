...
export const getAllProductsForBuyer = createAsyncThunk("products/getAllProductsForBuyer", async ({
                                                                                                   page,
                                                                                                   size
                                                                                                 }, { rejectWithValue }) => {
  try {
...
export const getAllProductsForSeller = createAsyncThunk("products/getAllProductsForBuyer", async ({
                                                                                                    page,
                                                                                                    size,
                                                                                                    finished
                                                                                                  }, { rejectWithValue }) => {
